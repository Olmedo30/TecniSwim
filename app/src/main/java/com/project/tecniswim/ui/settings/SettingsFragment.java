...
public class SettingsFragment extends Fragment {
    ...
    private void registerLaunchers() {
        ...
        galleryLauncher = registerForActivityResult(
                ...
                uri -> { if (uri != null) loadBitmapFromUri(uri); });
    ...
    private void checkPermsAndDialog() {
        ...
        if (need.isEmpty()) showImageDialog();
        else permLauncher.launch(need.toArray(new String[0]));
    }
    ...
    private void loadBitmapFromUri(Uri uri) {
        exec.execute(() -> {
            ...
            } catch (IOException e) { Log.e(TAG,"Galería",e); }
    ...
    private void loadBitmapFromUrl(String url) {
        exec.execute(() -> {
            ...
            } catch (IOException e) { Log.e(TAG,"URL",e); }
    ...
    private void loadUserData() {
        ...
        if (photoAuth != null)
            Glide.with(this).load(photoAuth).circleCrop().into(ivProfile);
        ...
        db.collection("Usuarios").document(uid).get()
                .addOnSuccessListener(snap -> {
                    ...
                    if (!TextUtils.isEmpty(base64)) setBitmapFromBase64(base64);
                })
    ...
    private void setBitmapFromBase64(String b64) {
        try {
            ...
            showCircularBitmap(bmp);
        } catch (IllegalArgumentException e) { Log.e(TAG,"Base64 inválido",e); }
    }
    ...
    private void showCircularBitmap(@NonNull Bitmap bmp) {
        Glide.with(this).load(bmp).circleCrop().into(ivProfile);
        currentBitmap = bmp;
    }
    ...
    private String nullToEmpty(@Nullable String s) { return s != null ? s : ""; }
